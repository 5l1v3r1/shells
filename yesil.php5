...
$password = "FSDKFSDJLKku8yu8y98jnLHNLjJL";
$pass=$_POST['pass'];
if($pass==$password){
$_SESSION['nst']="$pass";
}
...
body{
    ...
    background-image:url(https://pbs.twimg.com/media/Cu5js7dWAAEQwv-.jpg);
